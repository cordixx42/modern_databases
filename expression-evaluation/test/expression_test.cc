...
TEST(ExpressionTest, InterpretedComplexIntegerExpression) {
   ...
   for (int i = 0; i < 1000; ++i) {
      ...
      //   std::cout << "a1 " << static_cast<data64_t>(args[0]) << "\n";
      //   std::cout << "a2 " << static_cast<data64_t>(args[1]) << "\n";
      //   std::cout << "a3 " << static_cast<data64_t>(args[2]) << "\n";
      //   std::cout << "a4 " << static_cast<data64_t>(args[3]) << "\n";

      auto expected = (((42 + args[1]) * (21 - args[0]) * args[2]) + 100) / args[3];

      //   std::cout << "v1.gt" << " " << (42 + static_cast<data64_t>(args[1])) << "\n";
      //   std::cout << "v2.gt" << " " << (21 - static_cast<data64_t>(args[0])) << "\n";
      //   std::cout << "v3.gt" << " " << (42 + static_cast<data64_t>(args[1])) * (21 - static_cast<data64_t>(args[0])) << "\n";
      //   std::cout << "v4.gt" << " " << ((42 + static_cast<data64_t>(args[1])) * (21 - static_cast<data64_t>(args[0])) * static_cast<data64_t>(args[2])) << "\n";
      //   std::cout << "v5.gt" << " " << (((42 + static_cast<data64_t>(args[1])) * (21 - static_cast<data64_t>(args[0])) * static_cast<data64_t>(args[2])) + 100) << "\n";
      //   std::cout << "v6.gt" << " " << (((42 + static_cast<data64_t>(args[1])) * (21 - static_cast<data64_t>(args[0])) * static_cast<data64_t>(args[2])) + 100) / static_cast<data64_t>(args[3]) << "\n";

      //   std::cout << "v1.evaluate" << " " << v1.evaluate(reinterpret_cast<data64_t*>(args.data())) << "\n";
      //   std::cout << "v2.evaluate" << " " << v2.evaluate(reinterpret_cast<data64_t*>(args.data())) << "\n";
      //   std::cout << "v3.evaluate" << " " << v3.evaluate(reinterpret_cast<data64_t*>(args.data())) << "\n";
      //   std::cout << "v4.evaluate" << " " << v4.evaluate(reinterpret_cast<data64_t*>(args.data())) << "\n";
      //   std::cout << "v5.evaluate" << " " << v5.evaluate(reinterpret_cast<data64_t*>(args.data())) << "\n";
      //   std::cout << "v6.evaluate" << " " << v6.evaluate(reinterpret_cast<data64_t*>(args.data())) << "\n";
